...
import uz.taxi.user_service.config.filter.AfterFilter;
import uz.taxi.user_service.config.filter.BeforeFilter;
import uz.taxi.user_service.config.handler.AccessHandler;
import uz.taxi.user_service.config.handler.AuthHandler;
import uz.taxi.user_service.config.prop.AuthProp;
...
public class SecurityConfig {
    ...
    private final String[] PERMIT_URLS = new String[]{
            ...
            "/public/**",
            BaseURL.API1 + BaseURL.CLIENT + "/**",
            BaseURL.API1 + BaseURL.USER + "/**",
            "/v3/api-docs",
            "/v3/api-docs/**",
            "/swagger-ui.html",
            "/swagger-ui/**"
